<template>
  ...
  const solutions = [
    { name: 'Alumni Login', description: 'Get a better understanding of your traffic', href: '#', icon: ChartPieIcon },
    { name: 'Registration', description: 'Speak directly to your customers', href: '#', icon: CursorArrowRaysIcon },
    { name: 'Alumni Talk', description: "Your customers' data will be safe and secure", href: '#', icon: FingerPrintIcon },
    { name: 'Alumni meet', description: 'Connect with third-party tools', href: '#', icon: SquaresPlusIcon },
