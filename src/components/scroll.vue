      ...
      <div class="flex-none relative isolate flex items-center gap-x-6 px-6 sm:px-3.5 sm:before:flex-1">
        ...
        <div class="flex items-center gap-x-4 gap-y-2">
          <p class="text-sm leading-6 text-gray-900">
            <strong class="font-semibold">Register yourself for admission 2024-25 in UG &amp; PG programmes.</strong>
            <svg viewBox="0 0 2 2" class="mx-2 inline h-0.5 w-0.5 fill-current" aria-hidden="true">
              <circle cx="1" cy="1" r="1" />
            </svg>
            Visit us for admission counselling and free registration on admission portal.
          </p>
          <a href="#" class="flex-none rounded-full bg-gray-900 px-3.5 py-1 text-sm font-semibold text-white shadow-sm hover:bg-gray-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900">
            Admission Open now <span aria-hidden="true">&rarr;</span>
          </a>
        </div>
      </div>
    </div>
