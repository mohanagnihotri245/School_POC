<template>
  ...
  const solutions = [
    ...
    { name: 'list of holidays', description: 'Connect with third-party tools', href: '#', icon: SquaresPlusIcon },
    { name: 'TimeTable', description: 'Connect with third-party tools', href: '#', icon: SquaresPlusIcon },
