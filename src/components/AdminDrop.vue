<template>
  ...
  const solutions = [
    { name: 'Chairman Message', description: 'Get a better understanding of your traffic', href: '#', icon: ChartPieIcon },
    { name: 'Governing Message', description: 'Speak directly to your customers', href: '#', icon: CursorArrowRaysIcon },
    { name: 'Principal Message', description: "Your customers' data will be safe and secure", href: '#', icon: FingerPrintIcon },
    { name: 'Director Message', description: 'Connect with third-party tools', href: '#', icon: SquaresPlusIcon },
