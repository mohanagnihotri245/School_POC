<template>
  ...
  const solutions = [
    { name: 'About Society', description: 'Get a better understanding of your traffic', href: '#', icon: ChartPieIcon },
    { name: 'About Institute', description: 'Speak directly to your customers', href: '#', icon: CursorArrowRaysIcon },
    { name: 'Vission & Mission', description: "Your customers' data will be safe and secure", href: '#', icon: FingerPrintIcon },
    { name: 'Mandatory', description: 'Connect with third-party tools', href: '#', icon: SquaresPlusIcon },
    { name: 'AffIlation & Approval', description: 'Build strategic funnels that will convert', href: '#', icon: ArrowPathIcon },
  ]
