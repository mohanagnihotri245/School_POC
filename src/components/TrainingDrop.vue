<template>
  ...
  const solutions = [
    { name: 'Message', description: 'Get a better understanding of your traffic', href: '#', icon: ChartPieIcon },
    { name: 'Internship', description: 'Speak directly to your customers', href: '#', icon: CursorArrowRaysIcon },
    { name: 'Training', description: "Your customers' data will be safe and secure", href: '#', icon: FingerPrintIcon },
    { name: 'Placement Records', description: 'Connect with third-party tools', href: '#', icon: SquaresPlusIcon },
    { name: 'Industrial', description: 'Connect with third-party tools', href: '#', icon: SquaresPlusIcon },
    { name: 'Our Recruiters', description: 'Connect with third-party tools', href: '#', icon: SquaresPlusIcon },
